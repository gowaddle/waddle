...
/*    var query = [
   ...
   var query = [
    ...
    'ON CREATE SET checkin = {likes: {likes}, photos: {photos}, caption: {caption}, checkinTime: {checkinTime}}',
    'ON MATCH SET checkin.likes = {likes}, checkin.photos = {photos}, checkin.caption = {caption}',
