...
1. Cut a namespaced feature branch from dev
  ...
  - doc/...
  - refactor/...
1. Make commits to your feature branch.  Use the present tense.
1. When you've finished with your fix or feature, Rebase upstream changes into your branch. submit a pull request
    to dev. Include a description of your changes.
...
```
git remote add upstream https://github.com/gowaddle/waddle.git
```
...
- [ ] Did I cut my work branch off of dev (don't cut new branches from existing feature branches)?
